...
<div class="content-wrapper">
  ...
  <section class="content-header ">
    ...
    <h1 class="pull-right" >
       بەکارهێنەرەکان<small>ژووری</small>
    </h1>
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        ...
        <button style="font-family: 'NRT';" class="btn btn-primary pull-right" data-toggle="modal" data-target="#addUser">
                ...
                echo '
                  ...
                  <tr>
                    ...
                    if($value["status"] != 0){
                      ...
                      echo '<td><button style="font-family: NRT;" class="btn btn-success btnActivate btn-xs" userId="'.$value["id"].'" userStatus="0">چالاکە</button></td>';

                    }else{

                      echo '<td><button class="btn btn-danger btnActivate btn-xs" userId="'.$value["id"].'" userStatus="1">نا چالاکە</button></td>';
                    }
    ...
    <div class="modal-content">
      ...
      <form role="form" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-header" style="background: #3c8dbc; color: #fff">
          ...
          <h4 class="modal-title pull-right">زیادکردنی بەکارهێنەر</h4>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input class="form-control input-lg" type="text" name="newName" placeholder="ناو" required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input class="form-control input-lg" type="text" id="newUser" name="newUser" placeholder="ناوی بەکارهێنەر"
                  required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input class="form-control input-lg" type="password" name="newPasswd" placeholder="وشەی نهێنی"
                  required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select class="form-control input-lg" name="newProfile">
                  ...
                  <option value="">هەلبژاردنی پلە</option>
                  <option value="administrator">بەرێوبەر</option>
                  <option value="special">ژمێریار</option>
                  <option value="seller">فرۆشیار</option>
    ...
    <div class="modal-content">
      ...
      <form role="form" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-header" style="background: #3c8dbc; color: #fff">
          ...
          <h4 class="modal-title pull-right">گۆڕانکاری لە بەکارهێنەر</h4>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input class="form-control input-lg" type="text" id="EditName" name="EditName" placeholder="دەستکاریکردنی ناو"
                  required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input class="form-control input-lg" type="text" id="EditUser" name="EditUser" readonly>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input class="form-control input-lg" type="password" name="EditPasswd" placeholder="وشەی نهێنی">
